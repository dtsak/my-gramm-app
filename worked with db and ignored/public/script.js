document.addEventListener('DOMContentLoaded', function () {
    ...
    function displayResults() {
     ...
     //                           const question = questions.find(q => q.aa === score.aa);

        
                    //            const correctAnswer1 = question.answers.find(a => a.index == question.right1)?.text || 'N/A';
                    //            const correctAnswer2 = question.typeq === '5' ? (question.answers.find(a => a.index == question.right2)?.text || 'N/A') : 'N/A';
                                return `
                                    <tr>
                                        <td>${score.aa}</td>
